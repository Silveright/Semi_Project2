			...
			<div class="col-sm-9 ">
				...
				<div class="container">
      				<div class="row text-center">
        				   ...
        				   <div class="col-sm-6">
           					<!-- product detail.java에서 
           					request.setAttribute("product", product); "product"로 담았으니까 
           					${product.속성이름(자바빈)}를 사용해서 가져옵니다-->
          				   <p>상품명</p>${product.product_name }<!-- 정렬이 잘 안돼서 나오네요.. 나중에 알아보고 수정해야 할듯 싶어요 -->
						   <hr>
						   <p>판매가</p>${product.product_price }
						   <hr>
						   <p>배송정보</p><!-- 여기엔 뭘 쓰실건가요..? -->
						   <hr>
          				  ...
          				  <select name="size" id="size-select">
           				  ...
           				  <table class="total">
           				    ...
           				    <td>상품금액${product.product_price }</td>
           				  </table><br>
           				  
       				      
           			      <hr style="opacity: 1; background-color: black; margin: 0 auto">
          				  <p>총 상품 금액${product.product_price }</p><br>
          				  <button type="button" class="btn btn-dark">바로 구매하기</button>
					      <button type="button" class="btn btn-light">관심상품 담기</button><!--링크처리  -->
					      <button type="button" class="btn btn-light">장바구니 담기</button><!--링크처리  -->
          				  </div>       
         		    </div><br>
