...
<body>
<form action="payment.go" method="post">
			...
			<div class="col-sm-9 ">
				...
				<br>
							...
							<table class="table">
								...
								<td><fmt:formatNumber  value="${total_product }" pattern="#,###" />
								<input type="hidden" name="totalproductprice" value="${total_product}">
								</td>
				...
				<tbody>
					...
					<tr>
						...
						<td>
	            			...
	            			<input type="text" id="address_detail" name="address_detail" size="40" value="${memberinfo.address_detail}" class="requiredInfo" placeholder="상세주소" required style="margin-top: 4px;"/><br/>
		...
		<!-- 배송 정보 form 테이블 끝 -->
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<c:set var="sum" value="2500"/>
						<td class="text-center" style="width: 20%"><fmt:formatNumber  value="${sum+total_product}" pattern="#,###" />
									</td>
					</tr>
