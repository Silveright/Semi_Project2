				...
				<c:forEach var="b" items="${bottomlist}">			
					<div class="col mb-5">
						<div class="card h-100">
							<!-- Product image-->
							<img class="card-img-top" src="${pageContext.request.contextPath}/image/main/product/${b.product_image}.jpg" alt="${b.product_image}" />
							<!-- Product details-->
							<div class="card-body p-4">
								<div class="text-center">
									<!-- Product name-->
									<h5 class="fw-bolder">${b.product_name}</h5>
									<!-- Product price-->
									&#8361;<fmt:formatNumber type="number" maxFractionDigits="3" value="${b.product_price}" />
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									...
									<a class="btn btn-outline-dark mt-auto" href=" detail.do?product_code=${b.product_code} ">상세보기</a>  
								</div>
							</div>
						</div>
					</div>
