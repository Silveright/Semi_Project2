...
public class AddresslistAddProcessAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		address.setAddress_name(request.getParameter("name"));
		address.setAddress_receiver(request.getParameter("receiver"));
		address.setAddress_phone(request.getParameter("phone"));
